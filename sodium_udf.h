...
////////////////////////////////////////////////////////////////////////////////
// Buffer Declarations and Macros
...
{ main: \
    ...
    if (substr_field == NULL \
        || args->lengths[0] != (total_field_length) \
        || substr_field[boundary_pos] != BOUNDARY \
    ) { \
